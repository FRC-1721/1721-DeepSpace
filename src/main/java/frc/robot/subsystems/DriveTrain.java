...
public class DriveTrain extends Subsystem {
  ...
  public static void flyWithWires(TalonSRX starboard, TalonSRX port, double heading, double throttle){
      starboard.set(ControlMode.Velocity, heading + throttle); // Set the starboard drivetrain motor to the steering power requirement added to the base speed
      port.set(ControlMode.Velocity, heading - throttle); // Does the same but on the other side
  }
}